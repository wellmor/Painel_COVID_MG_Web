                ...
                <div class="col-md-6 float-left">
                    ...
                    <div class="btn-group">
                        ...
                        <div class="dropdown-menu">
                            <a class="dropdown-item" href="#" onclick="modalCadLegenda()"><span
                                        data-feather="plus"></span> Cadastrar</a>
                    ...
                    <button type="button" id="btnSumarizado" class="btn btn-success" data-toggle="modal"
                            onclick="toggleSumarizados()">
...
<!-- Modal casos -->
<div class="modal fade" id="modalCasosAE" tabindex="-1" data-backdrop="true" role="dialog"
     aria-labelledby="modalCasosAELabel" aria-hidden="true">
                ...
                <form id="formCasos" method="post">
                    <div class="form-group row">
                        ...
                        <div class="col-sm-6">
                            ...
                            <input type="number" value="" oninput="this.value = Math.abs(this.value)" min="0"
                                   class="form-control" name="confirmados" id="confirmados" placeholder="confirmados">
                        </div>
                        <div class="col-sm-6">
                            <label>Suspeitos </label>
                            <input type="number" oninput="this.value = Math.abs(this.value)" min="0"
                                   class="form-control" name="suspeitos" id="suspeitos" placeholder="suspeitos">
                        </div>
                        <div class="col-sm-6">
                            <label>Descartados</label>
                            <input type="number" oninput="this.value = Math.abs(this.value)" min="0"
                                   class="form-control" name="descartados" id="descartados" placeholder="descartados">
                        </div>
                        <div class="col-sm-6">
                            <label>Recuperados</label>
                            <input type="number" oninput="this.value = Math.abs(this.value)" min="0"
                                   class="form-control" name="recuperados" id="recuperados" placeholder="recuperados">
                        </div>
                        <div class="col-sm-6">
                            <label>Obitos</label>
                            <input type="number" oninput="this.value = Math.abs(this.value)" min="0"
                                   class="form-control" name="obitos" id="obitos" placeholder="obitos">
                        </div>
                        <div class="col-sm-6">
                            <label>Data</label>
                            <input type="date" class="form-control" name="data-caso" id="data-caso"
                                   placeholder="data do relatorio">
                        </div>
                        <div class="col-sm-12">
                            <label>Fonte</label>
...
<div class="modal fade" id="modalLegendasAE" tabindex="-1" role="dialog" aria-labelledby="modalLegendasAELabel"
     aria-hidden="true">
                ...
                <form id="formLegendas" method="post">
                    <div class="form-group">
                        ...
                        <textarea class="form-control" id="conteudo" name="conteudo"
                                  placeholder="Detalhe como os relatórios de casos estão sendo tratados, se houveram mudanças nas contagens etc."></textarea>
                    </div>
                </form>
            </div>
            <div class="modal-footer">
...
<div class="modal fade" id="modalLegendas" tabindex="-1" role="dialog" aria-labelledby="modalLegendasLabel"
     aria-hidden="true">
...
<script type="text/javascript"
        src="https://cdn.datatables.net/v/bs4/jszip-2.5.0/dt-1.10.21/b-1.6.2/b-html5-1.6.2/b-print-1.6.2/cr-1.5.2/r-2.2.5/datatables.min.js"></script>
