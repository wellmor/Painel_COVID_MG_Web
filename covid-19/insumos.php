        ...
        <div class="container">
            <section class="jumbotron text-center p-0">
                <ol class="breadcrumb">
                    ...
                    <li class="breadcrumb-item active" aria-current="page">Alvinópolis</li>
                </ol>
                <h2 class="jumbotron-heading">Painel CoronaVírus</h2>
                <p class="lead text-muted">Últimas Atualizaçãos</p>
                <p class="subtext">08/04/2020</p>
            </section>
            <div class="row">
                <div class="col-md-4">
                    <div class="card card-borda-azul animated bounceInUp slow">
                        <div class="card-body">
                            ...
                            <div class="col">    
                                <h3 class="cor1">0</h3>
                                <p class="subtext">Leitos</p>
                            </div>
                            <div class="col">
                                <img class="img" src="images/cama-de-hospital.png" width="70" height="70"  align="right" alt="">   
                            </div>    
                            </div>
                        </div>
                    </div>
                ...
                <div class="col-md-4">
                    <div class="card card-borda-amarelo animated bounceInUp slow">
                        <div class="card-body">
                            ...
                            <div class="col">    
                                <h3 class="cor2">0</h3>
                                <p class="subtext">Álcool/ml</p>
                            </div>
                            <div class="col">
                                <img class="img" src="images/desinfetante-para-as-maos.png" width="70" height="70"  align="right" alt="">   
                            </div>    
                            </div>
                        </div>
                    </div>
                ...
                <div class="col-md-4">
                    <div class="card card-borda-verde animated bounceInUp slow">
                        <div class="card-body">
                            ...
                            <div class="col">    
                                <h3 class="cor3">0</h3>
                                <p class="subtext">Luvas</p>
                            </div>
                            <div class="col">
                                <img class="img" src="images/luvas-de-protecao.png" width="70" height="70"  align="right" alt="">   
                            </div>    
                            </div>
                        </div>
                    </div>
            ...
            <div class="row">
                <div class="col-md-12">
                    <div class="card animated bounceInUp slow delay-1s">
                        <div class="card-body">
                            <h5 class="subtext">Mapa Unidade Saúde</h5>
