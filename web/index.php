...
<head>
  ...
  <link rel="stylesheet" href="./mapa/dist/leaflet-search.css" />
...
<body>
  ...
  <main role="main">
    <div class="container">
      <section class="jumbotron text-center center">
        <h2 class="jumbotron-heading center">Painel CoronaVírus</h2>
        <p class="lead text-muted"><i class="fas fa-map"></i> Escolha sua cidade ou microregião:</p>
        <form>
          <div class="md-form mt-0 animated flash slow">
            <input class="form-control" type="text" placeholder="Buscar" aria-label="Search">
          </div>  
          <div class="md-form mt-0 animated flash slow" style="margin-top: 6px !important;">
            <span class="col-md-2">
              Pesquisar por: 
            </span>
            <label class="col-md-2">
              <input type="radio" name="option" value="cidades" checked>Cidades
            </label>
            <label class="col-md-2">
              <input type="radio" name="option" value="regioes">Microregiões
            </label>
          </div>
        </form>
      </section>
      <div class="row">
        <div class="col-md-4">
          <div class="card animated bounceInUp slow delay">
            <div class="card-body" align="center">
              ...
              <a href="dicas.php" type="button" class="btn btn-outline-info btn-block">Ver Mais</a>
            </div>    
          </div>
        </div>
        <div class="col-md-4">
